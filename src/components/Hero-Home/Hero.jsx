    ...
    <div className="home-hero">
      ...
      <div className="text">
        <div className="title gdsc">
          <span className="gdsc-title-blue">D</span>
          <span className="gdsc-title-yellow">K</span>
          <span className="gdsc-title-red">T</span>
          <span className="gdsc-title-green">E</span>
          <span className="gdsc-title-green">'</span>
          <span className="gdsc-title-green">S</span>
        </div>
        <div className="title nits">Software <br></br>Development Club</div>
        <div className="twl">
